...
/*   Updated: 2026/09/23 15:54:41 by bribot           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	double	first[3] = {1.5, 3, 5};
	double	second[3] = {2, 4.5, 6};
